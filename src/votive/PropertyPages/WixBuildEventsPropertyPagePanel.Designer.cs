...
namespace WixToolset.VisualStudioExtension.PropertyPages
{
    ...
    partial class WixBuildEventsPropertyPagePanel
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.preBuildEditor = new WixBuildEventEditor();
            this.postBuildEditor = new WixBuildEventEditor();
            this.runPostBuildComboBox = new System.Windows.Forms.ComboBox();
            this.preBuildGroupBox = new WixGroupBox();
            this.postBuildGroupBox = new WixGroupBox();
        ...
        private WixBuildEventEditor preBuildEditor;
        private WixBuildEventEditor postBuildEditor;
        private System.Windows.Forms.ComboBox runPostBuildComboBox;
        private WixGroupBox preBuildGroupBox;
        private WixGroupBox postBuildGroupBox;
